...
struct RVData_ApplicationInfo: Sendable {
  ...
  var platformVersion: RVData_Version {
    get {_platformVersion ?? RVData_Version()}
    set {_platformVersion = newValue}
  }
  /// Returns true if `platformVersion` has been explicitly set.
  var hasPlatformVersion: Bool {self._platformVersion != nil}
  ...
  var applicationVersion: RVData_Version {
    get {_applicationVersion ?? RVData_Version()}
    set {_applicationVersion = newValue}
  }
  /// Returns true if `applicationVersion` has been explicitly set.
  var hasApplicationVersion: Bool {self._applicationVersion != nil}
...
extension RVData_ApplicationInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}platform\0\u{3}platform_version\0\u{1}application\0\u{3}application_version\0")
...
extension RVData_ApplicationInfo.Platform: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0PLATFORM_UNDEFINED\0\u{1}PLATFORM_MACOS\0\u{1}PLATFORM_WINDOWS\0")
}

extension RVData_ApplicationInfo.Application: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0APPLICATION_UNDEFINED\0\u{1}APPLICATION_PROPRESENTER\0\u{1}APPLICATION_PVP\0\u{1}APPLICATION_PROVIDEOSERVER\0\u{1}APPLICATION_SCOREBOARD\0")
}
