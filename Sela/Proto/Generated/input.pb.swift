...
struct RVData_VideoInput: @unchecked Sendable {
  ...
  var videoInputDevice: RVData_Media.VideoDevice {
    get {_storage._videoInputDevice ?? RVData_Media.VideoDevice()}
    set {_uniqueStorage()._videoInputDevice = newValue}
  }
  /// Returns true if `videoInputDevice` has been explicitly set.
  var hasVideoInputDevice: Bool {_storage._videoInputDevice != nil}
...
struct RVData_AudioInput: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct RVData_CloudVideoInput: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct RVData_CloudAudioInput: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension RVData_VideoInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}uuid\0\u{3}user_description\0\u{3}video_input_device\0\u{3}display_color\0\u{3}thumbnail_path\0\u{3}audio_device\0\u{3}video_device\0\u{3}audio_type\0\u{3}alpha_type\0")
...
extension RVData_VideoInput.AudioDeviceType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0AUDIO_DEVICE_TYPE_DEFAULT\0\u{1}AUDIO_DEVICE_TYPE_NONE\0\u{1}AUDIO_DEVICE_TYPE_ALTERNATE\0")
}
...
extension RVData_VideoInput.SettingsDocument: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}inputs\0")
...
extension RVData_AudioInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}uuid\0\u{3}user_description\0\u{3}audio_device\0\u{3}video_device\0\u{3}behavior_mode\0")

  fileprivate class _StorageClass {
    var _uuid: RVData_UUID? = nil
    var _userDescription: String = String()
    var _source: RVData_AudioInput.OneOf_Source?
    var _behaviorMode: RVData_AudioInput.BehaviorMode? = nil
...
extension RVData_AudioInput.BehaviorMode: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}on\0\u{1}off\0\u{3}auto_on\0\u{3}auto_off\0")
...
extension RVData_AudioInput.BehaviorMode.AutoOn: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}linked_video_inputs\0")
...
extension RVData_CloudVideoInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CloudVideoInput"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}uuid\0\u{3}user_description\0")
  ...
  static func ==(lhs: RVData_CloudVideoInput, rhs: RVData_CloudVideoInput) -> Bool {
...
extension RVData_CloudAudioInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CloudAudioInput"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}uuid\0\u{3}user_description\0")
  ...
  static func ==(lhs: RVData_CloudAudioInput, rhs: RVData_CloudAudioInput) -> Bool {
    if lhs._uuid != rhs._uuid {return false}
    if lhs.userDescription != rhs.userDescription {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
