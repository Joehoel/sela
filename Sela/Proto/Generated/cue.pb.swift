...
struct RVData_Cue: Sendable {
  ...
  var completionTargetUuid: RVData_UUID {
    get {_completionTargetUuid ?? RVData_UUID()}
    set {_completionTargetUuid = newValue}
  }
  /// Returns true if `completionTargetUuid` has been explicitly set.
  var hasCompletionTargetUuid: Bool {self._completionTargetUuid != nil}
  ...
  var completionActionUuid: RVData_UUID {
    get {_completionActionUuid ?? RVData_UUID()}
    set {_completionActionUuid = newValue}
  }
  /// Returns true if `completionActionUuid` has been explicitly set.
  var hasCompletionActionUuid: Bool {self._completionActionUuid != nil}
  ...
  var triggerTime: RVData_Cue.TimecodeTime {
    get {_triggerTime ?? RVData_Cue.TimecodeTime()}
    set {_triggerTime = newValue}
  }
  /// Returns true if `triggerTime` has been explicitly set.
  var hasTriggerTime: Bool {self._triggerTime != nil}
...
extension RVData_Cue.CompletionTargetType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0COMPLETION_TARGET_TYPE_NONE\0\u{1}COMPLETION_TARGET_TYPE_NEXT\0\u{1}COMPLETION_TARGET_TYPE_RANDOM\0\u{1}COMPLETION_TARGET_TYPE_CUE\0\u{1}COMPLETION_TARGET_TYPE_FIRST\0")
}

extension RVData_Cue.CompletionActionType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0COMPLETION_ACTION_TYPE_FIRST\0\u{1}COMPLETION_ACTION_TYPE_LAST\0\u{1}COMPLETION_ACTION_TYPE_AFTER_ACTION\0\u{1}COMPLETION_ACTION_TYPE_AFTER_TIME\0")
}
