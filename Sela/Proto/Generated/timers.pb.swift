...
struct RVData_Timer: Sendable {
  ...
  var configuration: RVData_Timer.Configuration {
    get {_configuration ?? RVData_Timer.Configuration()}
  ...
  struct Format: Sendable {
    ...
    var hour: RVData_Timer.Format.Style = .none

    var minute: RVData_Timer.Format.Style = .none

    var second: RVData_Timer.Format.Style = .none

    var millisecond: RVData_Timer.Format.Style = .none
...
struct RVData_TimersDocument: Sendable {
  ...
  var applicationInfo: RVData_ApplicationInfo {
    get {_applicationInfo ?? RVData_ApplicationInfo()}
    set {_applicationInfo = newValue}
  }
  /// Returns true if `applicationInfo` has been explicitly set.
  var hasApplicationInfo: Bool {self._applicationInfo != nil}
  ...
  var clock: RVData_Clock {
    get {_clock ?? RVData_Clock()}
    set {_clock = newValue}
  }
  /// Returns true if `clock` has been explicitly set.
  var hasClock: Bool {self._clock != nil}
...
extension RVData_Clock.Format: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{4}\u{2}date_type\0\u{3}time_format\0\u{3}military_time_enabled\0\u{c}\u{1}\u{1}")
...
extension RVData_Clock.Format.DateFormatterStyle: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0DATE_FORMATTER_STYLE_NONE\0\u{1}DATE_FORMATTER_STYLE_SHORT\0\u{1}DATE_FORMATTER_STYLE_MEDIUM\0\u{1}DATE_FORMATTER_STYLE_LONG\0\u{1}DATE_FORMATTER_STYLE_FULL\0")
}
...
extension RVData_Timer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}uuid\0\u{1}name\0\u{2}\u{8}configuration\0\u{c}\u{3}\u{1}\u{c}\u{4}\u{1}\u{c}\u{5}\u{1}\u{c}\u{6}\u{1}\u{c}\u{7}\u{1}\u{c}\u{8}\u{1}\u{c}\u{9}\u{1}")
...
extension RVData_Timer.Format: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}hour\0\u{1}minute\0\u{1}second\0\u{1}millisecond\0\u{3}is_wall_clock_time\0\u{3}is_24_hour_time\0\u{3}show_milliseconds_under_minute_only\0")
...
extension RVData_Timer.Format.Style: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0STYLE_NONE\0\u{1}STYLE_SHORT\0\u{1}STYLE_LONG\0\u{1}STYLE_REMOVE_SHORT\0\u{1}STYLE_REMOVE_LONG\0")
}
...
extension RVData_Timer.Configuration: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}countdown\0\u{3}countdown_to_time\0\u{3}elapsed_time\0\u{3}allows_overrun\0")
...
extension RVData_Timer.Configuration.TimerTypeCountdownToTime: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}time_of_day\0\u{1}period\0")
...
extension RVData_Timer.Configuration.TimerTypeCountdownToTime.TimePeriod: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0TIME_PERIOD_AM\0\u{1}TIME_PERIOD_PM\0\u{1}TIME_PERIOD_24\0")
}
...
extension RVData_Timer.Configuration.TimerTypeElapsedTime: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}start_time\0\u{3}end_time\0\u{3}has_end_time\0")
...
extension RVData_TimersDocument: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}application_info\0\u{1}clock\0\u{1}timers\0")
